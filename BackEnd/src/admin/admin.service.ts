...
import { IncorrectPasswordException, NotFoundAdminIdException } from './exceptions/admin.exception';
...
export class AdminService {
    ...
    async authenticateWithAdminIdAndPassword(admin: Pick<Admin, 'adminId' | 'adminPw'>) {
