...
private extension ExerciseCardCell {
  func setupConstraints() {
    ...
    exerciseIconDescriptionLagel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -12).isActive = true
    exerciseIconDescriptionLagel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 0).isActive = true
    exerciseIconDescriptionLagel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: 0).isActive = true
